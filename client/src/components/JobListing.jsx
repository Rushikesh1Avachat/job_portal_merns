    ...
    const handleLocationChange=(location)=>{
        setSelectedLocations(prev=> prev.includes(location) ? prev.filter(c => c!== location ): [...prev, location])
            ...
            useEffect(() => {
             ...
             const newFilteredJobs = jobs.slice().reverse().filter( job => matchesCategory(job) && matchesLocations(job) && matchesTitle(job) && matchesSearchLocation(job))
  ...
  return (
    <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8 '>
        ...
        <div className={showFilter ? "" : "max-lg:hidden"}>
            <h4 className='text-lg font-medium py-4'>Search by Categories</h4>
    ...
    {category}
        ...
        <div className={showFilter ? "" : "max-lg:hidden"}>
            <h4 className='text-lg font-medium py-4 pt-14'>Search by Location</h4>
           <ul className='space-y-4 text-gray-600 '>
