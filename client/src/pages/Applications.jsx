...
<tr>
  <td className='py-3 px-4 flex items-center gap-4 border-b'>
  ...
  <td className='px-4 py-2 border-b'> 
    <span className={` ${job.status === "Accepted" ? "bg-green-100" : job.status==="Rejected " ? "bg-red-100": "bg-blue-100"} px-4 py-2 rounded`}>{job.status}</span></td>
</tr>
      ) : (null))}
    </tbody>
  </table>
